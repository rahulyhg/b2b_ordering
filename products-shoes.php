  ...
  <body>
    ...
    <section>
      <div class="container-fluid">
        <!-- HERO IMAGE -->
        <div class="row">
          <div class="hero-image products-shoes-image col-md-12 col-lg-12 col-lg-offset-0">
          </div>
        </div>
        <!-- HERO BORDER -->
        <div class="row">
        ...
        <div class="row">
          <div class="hero-heading-container col-sm-offset-1 col-md-offset-1 col-lg-6 col-lg-offset-1">
            <h2 class="hero-heading">FOOTWEAR</h2>
          </div>
        </div>
      </div>
      <!-- HERO BG BAR -->
      <div class="hero-bar shoes-bar"></div>
    </section>
      ...
      <div class="container">
        ...
        <div class="col-xs-12">
          <div class="row">
            ...
            <a href="products-lifestyleS.php">
